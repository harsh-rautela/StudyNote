...
import CourseCard from "../components/core/Catalog/CourseCard2"
import CourseSlider from "../components/core/Catalog/CourseSlider"
import { useEffect,useState } from "react"
import Error from "../pages/Error"
function Catalog(){
 const parm = useParams();
 const catalogName= parm.catalogName;
   ...
   <>
       <div className=" box-content bg-richblack-800 px-4">
        ...
        <div>
            ...
            {/* section2 */}
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
            <div className="text-2xl font-bold text-richblack-5 lg:text-4xl">Top Courses in {catalogPageData?.data?.newdiffCategory
?.name}</div>
                <div className="py-8">
                    <CourseSlider Courses={catalogPageData?.data?.newdiffCategory
?.course}/>
                </div>
            </div>
