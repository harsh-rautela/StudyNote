...
function SubSectionModal({
  ...
  const handleEditSubsection = async () => {
    ...
    if (currentValues.lectureVideo !== modalData.videoUrl) {
      ...
      console.log(" i am inside lecturevideo handle edit",currentValues.lectureVideo)
    }
    setLoading(true)
  ...
  const onSubmit = async (data) => {
   ...
   return (
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-scroll bg-white bg-opacity-10 backdrop-blur-sm">
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800 max-h-[600px] overflow-scroll">
        {/* Modal Header */}
