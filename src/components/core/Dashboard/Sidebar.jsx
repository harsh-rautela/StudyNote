...
function Sidebar(){
    ...
    return (
           ...
           <>
            <div className="flex  min-w-[220px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800 py-10 md:flex-col ">
                ...
                <div className="flex md:flex-col flex-row ">
                    ...
                    <button onClick={()=>setConfirmationModal({
                        text1:"Are you sure ?",
                        text2:"You will we logged of your account",
                        btn1Text:"Logout",
                        btn2Text:"Cancel",
